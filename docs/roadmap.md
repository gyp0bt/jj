...
| T7: Ollama AI連携 | **進行中** | Phase 7-1〜7-6完了（AIProvider・summarize・diff・RAG・Tips・ダッシュボード） |
| T8: 汎用データ管理 | **完了** | Phase 8-1〜8-5完了（Run Discovery・実験プラグイン・ガイド・Config汎用化・Run比較汎用化） |
