...
> 規約は [ルート CLAUDE.md](../CLAUDE.md) を参照。
...
| ドキュメント | 説明 |
|-------------|------|
| [最新status](../docs/status/status-002.md) | v0.2.0 実装状況の最新記録（ルート共有） |
| [v0.1.0 statusインデックス](../docs/status/status-index-v0.1.0.md) | v0.1.0全statusファイルの索引 |
