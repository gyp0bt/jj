...
export const PROPERTY_KEY_LABELS: Record<string, string> = {
  ...
  project: "プロジェクト",
  verbose_name: "表示名",
  // jj由来: メッシュ統計プロパティ（neo4j_schema.PropertyKey）
  mesh_node_count: "メッシュノード数",
  mesh_element_count: "メッシュ要素数",
  mesh_element_quality: "要素品質",
  mesh_topology_groups: "トポロジーグループ",
  mesh_elset_summary: "Elsetサマリー",
  mesh_element_types: "要素タイプ",
  // jj由来: diff関連プロパティ
  diff_summary: "差分要約",
  diff_details: "差分詳細",
  diff_unified: "Unified差分",
  has_diffs: "差分あり",
  // jj由来: ノードタイプ
  calculation_input: "解析入力",
  mesh: "メッシュ",
  step: "ステップ",
  result: "結果",
  asset: "アセット",
  folder: "フォルダ",
  output: "出力",
  abaqus_material: "材料定義",
  abaqus_elset: "要素セット",
  version_diff: "バージョン差分",
  run: "実行ジョブ",
  tag: "タグ",
  // jj由来: リレーションラベル
  next_version: "次バージョン",
  same_index_group: "同一条件",
  includes: "インクルード",
  has_output: "出力あり",
  derived_from: "派生元",
  result_of: "結果元",
